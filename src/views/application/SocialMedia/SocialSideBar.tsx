                        ...
                        <Row className="g-2">
                            <Col xs={4}>
                                <Link to="#" className="img-post card" data-lightbox={socgal1}>
                                    <img src={socgal1} alt="img" className="card-img img-fluid" />
                            ...
                            <Col xs={4}>
                                <Link to="#" className="img-post card" data-lightbox={socgal2}>
                                    <img src={socgal2} alt="img" className="card-img img-fluid" />
                                    <div className="card-img-overlay">
                                        <i className="ti ti-search"></i>
                                    </div>
                                </Link>
                            ...
                            <Col xs={4}>
                                <Link to="#" className="img-post card" data-lightbox={socgal3}>
                                    <img src={socgal3} alt="img" className="card-img img-fluid" />
                                    <div className="card-img-overlay">
                                        <i className="ti ti-search"></i>
                                    </div>
                                </Link>
                            ...
                            <Col xs={4}>
                                <Link to="#" className="img-post card" data-lightbox={socgal4}>
                                    <img src={socgal4} alt="img" className="card-img img-fluid" />
                                    <div className="card-img-overlay">
                                        <i className="ti ti-search"></i>
                                    </div>
                                </Link>
                            ...
                            <Col xs={4}>
                                <Link to="#" className="img-post card" data-lightbox={socgal5}>
                                    <img src={socgal5} alt="img" className="card-img img-fluid" />
                                    <div className="card-img-overlay">
                                        <i className="ti ti-search"></i>
                                    </div>
                                </Link>
                            ...
                            <Col xs={4}>
                                <Link to="#" className="img-post card" data-lightbox={socgal6}>
                                    <img src={socgal6} alt="img" className="card-img img-fluid" />
                                    <div className="card-img-overlay">
                                        <i className="ti ti-search"></i>
                                    </div>
                                </Link>
                            ...
                            <Col xs={4}>
                                <Link to="#" className="img-post card" data-lightbox={socgal7}>
                                    <img src={socgal7} alt="img" className="card-img img-fluid" />
                                    <div className="card-img-overlay">
                                        <i className="ti ti-search"></i>
                                    </div>
                                </Link>
                            ...
                            <Col xs={4}>
                                <Link to="#" className="img-post card" data-lightbox={socgal8}>
                                    <img src={socgal8} alt="img" className="card-img img-fluid" />
                                    <div className="card-img-overlay">
                                        <i className="ti ti-search"></i>
                                    </div>
                                </Link>
                            ...
                            <Col xs={4}>
                                <Link to="#" className="img-post card" data-lightbox={socgal9}>
                                    <img src={socgal9} alt="img" className="card-img img-fluid" />
                                    <div className="card-img-overlay">
                                        <i className="ti ti-search"></i>
                                    </div>
                                </Link>
