const menuItems = [
    ...
    { id: "chart", label: "Chart", icon: "ph-duotone ph-chart-pie", link: "/widget/w_chart", dataPage: "w_chart" },
            ...
            submenu: [
                {
                    ...
                    submenu: [
                        { id: "helpdeskcreate", label: "Create", link: "/admins/helpdesk-create-ticket", dataPage: "create" },
                        { id: "helpdesklist", label: "List", link: "/admins/helpdesk-ticket", dataPage: "list" },
                        { id: "helpdeskdetails", label: "Details", link: "/admins/helpdesk-ticket-details", dataPage: "details" },
                    ]
                },
        ...
        },
        {
            ...
            submenu: [
                ...
                { id: "invoicecreate", label: "Create", link: "/application/invoice-create", dataPage: "invoice-create" },
        ...
        
        {
            ...
            submenu: [
                { id: "invoice2create", label: "Create", link: "/admins/invoice-create", dataPage: "invoice-create2" },
                { id: "invoice2details", label: "Details", link: "/admins/invoice-view", dataPage: "invoice-details" },
                { id: "invoice2list", label: "List", link: "/admins/invoice-list", dataPage: "invoice-list" },
        ...
        },
        {
            ...
            submenu: [
                ...
                },
                {
                    ...
                    submenu: [
                        { id: "list", label: "list", link: "/admins/course-student-list", dataPage: "student-list" },
                        { id: "teacherapply", label: "Apply", link: "/admins/course-student-apply", dataPage: "student-apply" },
                        { id: "teacheradd", label: "Add", link: "/admins/course-student-add", dataPage: "add" },
                    ]
                },
                {
    ...
    { id: "Wizard", label: "Wizard", icon: "ph-duotone ph-tabs", link: "/forms/form2_wizard", dataPage: "forms-form_wizard" },
