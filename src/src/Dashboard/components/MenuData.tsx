const menuItems = [
    ...
    {
        type: "HASHMENU", id: 1, label: "My projects", icon: "ph-duotone ph-calendar-blank", dataPage: null,link:"/projects"
    },
    {
        type: "HASHMENU", id: 1, label: "My offers", icon: "ph-duotone ph-flag", dataPage: null,link:"/offerPage"
    },
    {
        type: "HASHMENU", id: 1, label: "Create new Offer", icon: "ph-duotone ph-gear-six", dataPage: null,link:"/offer"
    },
    {
        type: "HASHMENU", id: 1, label: "My Profile", icon: "ph-duotone ph-user-circle", dataPage: null,link:"/profile"  
    },
    {
